...
function resolveOpenCvScriptPath() {
...
export function listQqFarmTemplateNames(prefix) {
...
export function detectQqFarmTemplateBatchDetailed(source, queries) {
...
export function detectQqFarmTemplateBatch(source, queries) {
...
export function detectBestQqFarmTemplateMatch(source, templateNames, options = {}) {
...
export function detectQqFarmTemplateMatches(source, templateNames, options = {}) {
  return (
