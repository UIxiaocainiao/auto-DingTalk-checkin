 ...
 *
 * Usage:
 *   npx tsx main.ts login              # QR-code login only
 *   npx tsx main.ts start              # QR-code login + start bot
 *
...
用法:
  npx tsx main.ts login    仅扫码登录微信
  npx tsx main.ts start    每次启动前重新扫码并启动 bot
